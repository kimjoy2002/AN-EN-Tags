            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown" id="navitemRegion">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item reg unselectable" onclick="regDropdown($(this))" value="kr">Korea</a>
                        </div>
                    </li>
                <li class="nav-item dropdown" id="navitemLanguage">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item lang unselectable" onclick="langDropdown($(this))" value="kr">Korea</a>
                    </div>
                </li>
            </ul>
        </div>
